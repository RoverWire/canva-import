namespace :template do
  ...
  task :download, [:batch_size, :max_size, :record_id] do |task, args|
    ...
    Imports::DownloadService.call(args[:batch_size], args[:max_size], args[:record_id])
  end
  ...
  task :upload, [:batch_size] do |task, args|
    ...
    Imports::UploadService.call(args[:batch_size])
  end
  ...
  task :status, [:batch_size, :check_all] do |task, args|
    ...
    Imports::StatusService.call(args[:batch_size], args[:check_all])
  end
